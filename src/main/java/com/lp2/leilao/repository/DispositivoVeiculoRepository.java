...
@Repository
public interface DispositivoVeiculoRepository extends JpaRepository <DispositivoVeiculo,Long> {

    @Query("SELECT pv FROM DispositivoInformatica pv " +
    ...
    List<DispositivoInformatica> buscarPorFiltros(
