...
import com.lp2.leilao.repository.LanceDispositivoVeiculoRepository;
...
public class ClienteService {
    ...
    public List<ExibicaoLanceProdutoDTO> procurarLancesPorCpf(String cpf) {
        ...
        List<LanceDispositivoInformatica> listaLancesInfo = lanceDispositivoInformaticaRepository.findAllByCliente(cliente.get());
        List<LanceDispositivoVeiculo> listaLancesVei = lanceDispositivoVeiculoRepository.findAllByCliente(cliente.get());
